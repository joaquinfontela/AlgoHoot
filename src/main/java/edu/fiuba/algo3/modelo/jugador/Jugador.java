...
public class Jugador {
    ...
    public Multiplicador obtenerMultiplicadorX2() throws Exception {
        ...
        if (multiplicadoresX2.empty()) throw new Exception("Ya no le quedan más multiplicadoresX2");
    ...
    public Multiplicador obtenerMultiplicadorX3() throws Exception {
        ...
        if (multiplicadoresX3.empty()) throw new Exception("Ya no le quedan más multiplicadoresX3");
    ...
    public ExclusividadDePuntaje obtenerExclusividad() throws Exception {
        ...
        if (exclusividades.empty()) throw new Exception("Ya no le quedan más exclusividades");
